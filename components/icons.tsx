...
export const LinkedInIcon = () => {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M1.146 0C.513 0 0 .526 0 1.175v13.65C0 15.475.513 16 1.146 16h13.708C15.487 16 16 15.487 16 14.854V1.146C16 .525 15.487 0 14.854 0H1.146zM4.748 5.5H2.537v7.5h2.211v-7.5zm-1.107-1.778c.71 0 1.147-.5 1.147-1.125 0-.637-.437-1.125-1.135-1.125-.699 0-1.147.488-1.147 1.125 0 .625.438 1.125 1.122 1.125h.013zm9.605 8.908h-2.208v-4.06c0-.22.015-.445.083-.607.182-.447.598-.91 1.3-.91.916 0 1.284.686 1.284 1.692v4.008zm0-6.525c0-1.967-1.048-2.88-2.448-2.88-1.124 0-1.63.633-1.91 1.078v-1.03h-2.208v7.5h2.208v-4.183c0-.223.015-.447.083-.607.182-.447.598-.91 1.3-.91.916 0 1.284.686 1.284 1.692v4.008h2.208v-4.06z"
      />
    </svg>
  );
};
